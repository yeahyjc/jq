$(function(){
	...
	$(".car_c_title p").html("<初代奥特曼>是日本奥特曼系列中的巨大变身英雄");	//第一张图的标题
	//以下数组中的颜色与主图两边颜色同步的背景色(不同用户用脑分辨率不同导致图片无法铺满时,通过背景色的补充,起到铺满的作用)
	var rgb_arr = new Array("rgb(198, 198, 198)","rgb(238, 238, 238)","rgb(224, 232, 219)");	
	//所有标题
	var title_arr = new Array("<初代奥特曼>是日本奥特曼系列中的巨大变身英雄","<迪迦奥特曼>“迪迦”一词意为印度尼西亚语中神圣的数字3","<机动奥特曼>改编自清水荣一和下口智裕创作的同名漫画");
	//自动轮播方法
